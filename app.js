...
function startScanner() {
  ...
  html5QrScanner.start(
   ...
   .catch(function () { showResult('fail', '!', 'CAMERA ERROR', 'Could not start camera. Use manual entry below.'); });
}
